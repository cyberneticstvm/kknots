...
<body>
    ...
    <div class="menu-pop menu-pop1">
        ...
        <div class="inn">
            <img src="{{ asset('/assets/images/logo-b.png') }}" alt="" loading="lazy" class="logo-brand-only">
                ...
                <ul>
                    <li>
                        <div class="rel-pro-img">
                            <img src="{{ asset('/assets/images/couples/1.jpg') }}" alt="" loading="lazy">
                        </div>
            ...
            <div class="row">
                <div class="hom-nav">
                    ...
                    <div class="logo">
                        ...
                        <a href="index.html" class="logo-brand"><img src="{{ asset('/assets/images/logo-b.png') }}" alt="" loading="lazy" class="ic-logo"></a>
                    </div>
